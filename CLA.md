# Knowledge Tree Individual Contributor License Agreement

Thank you for your interest in contributing to Knowledge Tree (the "Project"),
maintained by OpenKTree Contributors ("We" or "Us").

This Contributor License Agreement ("Agreement") documents the rights granted
by contributors to Us. This is a legally binding document, so please read it
...
the purpose of discussing and improving the Project, but excluding communication
that is conspicuously marked or otherwise designated in writing by You as
"Not a Contribution."

**"Project"** means the Knowledge Tree software and associated documentation
available at https://github.com/openktree/knowledge-tree.
...
Project to which such Contribution(s) was submitted. If any entity institutes
...
(b) Each of Your Contributions is Your original creation (see Section 6 for
...
You sign this CLA by commenting on your pull request with the following
statement:

> I have read the CLA Document and I hereby sign the CLA

Your signature will be recorded automatically by our CLA bot.
