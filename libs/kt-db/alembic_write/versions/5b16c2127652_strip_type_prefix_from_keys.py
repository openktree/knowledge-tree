...
def _repoint_seed_refs(conn: sa.engine.Connection, loser: str, winner: str) -> None:
...
def _repoint_node_refs(conn: sa.engine.Connection, loser: str, winner: str) -> None:
